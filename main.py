...
class BankAccount:
    def __init__(self, accountNumber, name, currency, balance):
...
class FixedDeposit(BankAccount):
    def __init__(self, accountNumber, name, currency, balance, duration, amount, rateOfInterest):
        super().__init__(accountNumber, name, currency, balance)
...
class RecurringDeposit(BankAccount):
    def __init__(self, accountNumber, name, currency, balance, duration, monthlyPayment, rateOfInterest):
        super().__init__(accountNumber, name, currency, balance)
        self.__duration = duration
...
class BankDemo:
    ...
    def readWriteFixedDeposit(self) -> object:
        ...
        while(j == 0):
            try:
                currency = str(input("Currency: ").strip())
                j = 1
            except:
                print("Please try again")
        j = 0
    ...
    def readWriteRecurringDeposit(self, balance=None):
        ...
        rd = RecurringDeposit(accountNumber, name, currency, balance,  duration, monthlyPayment, rateOfInterest)

        print("\nRecurring Deposit Details are...\n")
        print("\nAccount Number: ", rd.get_account_number())
        print("Account Name: ", rd.get_name())
        print("Currency" , rd.get_currency())
        print("Balance", rd.get_balance())
